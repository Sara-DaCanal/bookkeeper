...
public class LedgerStorageTest {
    ...
    public void test() {
       try{
           ...
           Assert.assertEquals(expectedResult.readCharSequence(result.capacity(), Charset.forName("utf-8")).toString(), result.readCharSequence(result.capacity(), Charset.forName("utf-8")).toString());
       }catch(IOException e){
